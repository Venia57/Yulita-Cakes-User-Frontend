...
const sortOptions = [
  ...
  { value: "product_name-asc", label: "Nama (A-Z)" },
  { value: "product_name-desc", label: "Nama (Z-A)" },
  { value: "original_price-asc", label: "Harga Terendah" },
  { value: "original_price-desc", label: "Harga Tertinggi" },
];
...
const Product = () => {
  ...
  const handleSortSelection = (selectedValue) => {
    ...
    >
      <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="sticky top-24 p-1">
            ...
            <div
              className={`bg-gray-50 dark:bg-gray-900/70 p-5 rounded-lg shadow-sm ${
                showFilterSidebar ? "block" : "hidden" // Tampilkan jika state true, sembunyikan jika false
              } md:block`} // Selalu tampilkan di layar md ke atas, menimpa 'hidden' jika perlu
            >
        ...
        >
          ...
          <div className="w-full mt-2 sm:mt-0 mb-4">
            <CustomSelect
              options={sortOptions}
              selectedValue={sortType}
              onChange={handleSortSelection}
              placeholder="Urutkan..."
              // Untuk membuatnya overlay (absolute), tambahkan: absolutePosition={true}
